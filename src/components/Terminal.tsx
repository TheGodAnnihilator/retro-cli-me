...
export const Terminal = () => {
  ...
  const [output, setOutput] = useState<TerminalLine[]>([
    {
      type: 'system',
      content: '   ___   ____   ___  _   _ ___ _____   ____   ___  _   _    _  _____ ____ ___ ',
    },
    {
      type: 'system',
      content: '  / _ \\ |  _ \\ / __|| | | |_ _|_   _| |  _ \\ / _ \\| | | |  / ||_   _/ ___|_ _|',
    },
    {
      type: 'system',
      content: ' | |_| || |_) | |   | |_| || |  | |   | |_) | | | | |_| | | | | | | | |  | | ',
    ...
    {
      type: 'system',
      content: ' |  _  ||  _ <| |___|  _  || |  | |   |  _ <| |_| |  _  | | | | | | |_| | | | ',
    },
    {
      type: 'system',
      content: ' | | | || |_) |\\____| | | || |  | |   | |_) |  _  | | | | | | | | |\\____|_| | ',
    },
    {
      type: 'system',
      content: ' |_| |_||____/      |_| |_|___| |_|   |____/|_| |_|_| |_| |_| |_|       |___|',
    },
    {
      type: 'system',
      content: '',
