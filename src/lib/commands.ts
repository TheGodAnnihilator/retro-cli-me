...
const aboutCommand = (): CommandResult => ({
  output: [
    ...
    { type: 'output', content: 'Passionate developer specializing in Python, automation,' },
    { type: 'output', content: 'and full-stack development. Creator of innovative desktop' },
    { type: 'output', content: 'applications and video processing tools.' },
    { type: 'output', content: '' },
    { type: 'output', content: 'Director of Ashwamedh - The Dramatics Society of NSUT,' },
    { type: 'output', content: 'and Author of "Tears of Ichor".' },
    { type: 'output', content: '' },
  ],
});
